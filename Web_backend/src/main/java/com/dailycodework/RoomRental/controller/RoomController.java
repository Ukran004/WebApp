...
import com.dailycodework.RoomRental.response.BookingResponse;
import com.dailycodework.RoomRental.response.RoomResponse;
...
//            @RequestParam("roomPrice") BigDecimal roomPrice
            @RequestBody RoomDto roomdto) throws SQLException, IOException {
        Room savedRoom = roomService.addNewRoom(null, roomdto.getRoomType(), roomdto.getRoomPrice());
